    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden">
      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-3xl py-32 text-center">
          ...
          <div className="mt-8 flex justify-center rounded-lg bg-black/20 py-8 ring-2 ring-black/30 backdrop-blur-sm">
              ...
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="relative flex-1 text-neutral-200">
                  ...
                  <Input
                    ...
                    className="h-12 pl-10 text-white placeholder:text-neutral-200 focus-visible:ring-2 focus-visible:ring-black/30"
                    required
                    disabled={isLoading}
                  />
                </div>
